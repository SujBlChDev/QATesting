 ...
 */
public class StudentBorrowDetails extends javax.swing.JFrame {

    /**
     * Creates new form HomePage
     */
    public StudentBorrowDetails() {
        initComponents();
        noOfPending();
        noOfReturned();
        createSession();
    ...
    private void jLabel8MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseExited
        jPanel8.setBackground(new Color(251,51,51));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentBorrowDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentBorrowDetails().setVisible(true);
            }
        });
